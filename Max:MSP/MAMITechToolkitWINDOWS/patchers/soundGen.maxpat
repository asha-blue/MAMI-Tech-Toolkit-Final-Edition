...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 649.5, 128.0, 158.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.5, 97.5, 55.0, 23.0 ],
					"style" : "",
					"text" : "midiinfo"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 719.0, 234.5, 48.0, 23.0 ],
					"style" : "",
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.5, 64.0, 70.0, 23.0 ],
					"style" : "",
					"text" : "controllers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 31.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "midiinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 125.0, 72.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "midiin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 816.0, 449.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "print"
				}
...
,
					"patching_rect" : [ 820.0, 296.0, 42.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 823.5, 263.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 820.0, 326.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "s b2"
				}
...
,
					"patching_rect" : [ 769.0, 296.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 772.5, 263.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 799.333374, 238.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "Buttons"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 769.0, 326.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "s b1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 895.0, 308.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "s scale"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 895.0, 275.0, 88.0, 22.0 ],
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 57.0, 176.0, 61.0, 22.0 ],
									"style" : "",
									"text" : "route 144"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 98.0, 68.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 66.0, 293.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 66.0, 21.0, 24.0, 24.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 780.0, 377.0, 89.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 419.0, 699.0, 168.0, 22.0 ],
					"style" : "",
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.0, 656.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "pack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 809.5, 581.0, 182.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 649.5, 547.0, 112.0, 25.0 ],
					"style" : "",
					"text" : "duration in ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 562.0, 516.0, 72.0, 25.0 ],
					"style" : "",
					"text" : "velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 475.0, 484.0, 245.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 593.5, 549.0, 53.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 419.0, 435.0, 224.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 419.0, 612.0, 193.5, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 506.25, 518.0, 53.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 419.0, 486.0, 53.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 769.0, 584.0, 34.0, 23.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 737.0, 101.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 31.0, 99.430786, 159.0 ],
					"presentation_rect" : [ 0.0, 0.0, 105.616196, 135.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 0.0, 99.0, 22.0 ],
					"style" : "",
					"text" : "r midiOutInternal"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 411.0, 280.0, 234.0, 116.0 ],
					"varname" : "bp.ADSR",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 19.0, 146.0, 163.0, 116.0 ],
					"varname" : "MIDI",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.0, 549.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.0, 407.0, 304.0, 116.0 ],
					"varname" : "bp.LPF",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 280.0, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 26.5, 683.0, 148.0, 116.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 13.5, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 778.5, 321.0, 766.0, 321.0, 766.0, 260.0, 782.0, 260.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 209.5, 256.0, 190.5, 256.0, 190.5, 135.0, 28.5, 135.0 ],
					"order" : 1,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 829.5, 321.0, 817.0, 321.0, 817.0, 260.0, 833.0, 260.0 ],
					"source" : [ "obj-64", 0 ]
				}
