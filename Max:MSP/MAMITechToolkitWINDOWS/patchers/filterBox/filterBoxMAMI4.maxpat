...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 910.0, 576.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 326.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 66.0, 326.5, 150.0, 20.0 ],
					"style" : "",
					"text" : "sound"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.0, 29.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 335.75, 34.0, 86.0, 20.0 ],
					"style" : "",
					"text" : "Load interface"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 36.0, 113.0, 20.0 ],
					"style" : "",
					"text" : "Virtual Instrument"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 149.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 39.5, 59.0, 48.0, 20.0 ],
					"style" : "",
					"text" : "Scale"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 134.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 91.5, 73.0, 20.0 ],
					"style" : "",
					"text" : "Tonic Note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 103.0, 328.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 182.934067, 348.5, 150.0, 20.0 ],
					"style" : "",
					"text" : "AUDIO OUTPUT"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 358.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 325.0, 319.0, 53.0, 20.0 ],
					"style" : "",
					"text" : "volume"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 328.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 411.0, 319.0, 42.0, 20.0 ],
					"style" : "",
					"text" : "level"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1040.0, 143.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "s root"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1040.0, 58.0, 196.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 97.125, 81.0, 252.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1247.0, 501.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1247.0, 460.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "pak 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1247.0, 414.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "Uzi 16 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1247.0, 314.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 1247.0, 560.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "ctlout 123 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 576.0, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 264.5, 58.0, 58.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 680.75, 460.0, 60.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 166.0, 324.5, 60.0, 22.0 ],
					"style" : "",
					"text" : "STEREO"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 378.0, 641.0, 80.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 399.0, 57.0, 64.0, 265.5 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 740.0, 75.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 311.75, 34.0, 22.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 623.0, 75.0, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.5, 34.0, 203.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 232.166687, 169.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 357.0, 471.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 517.0, 297.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 641.0, 460.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 641.0, 525.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "set 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 934.0, 87.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "s scale"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 934.0, 54.0, 88.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.5, 57.0, 228.25, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 154.5, 359.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 154.5, 313.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "peak"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 104.0, 359.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 104.0, 313.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "trough"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 357.0, 508.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 62.0, 264.5, 58.0, 58.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 596.75, 460.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 641.0, 422.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 259.5, 324.5, 29.5, 22.0 ],
					"style" : "",
					"text" : "R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 558.5, 460.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 558.5, 422.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 228.0, 324.5, 29.5, 22.0 ],
					"style" : "",
					"text" : "L"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 528.5, 460.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.75, 380.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 357.0, 427.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.75, 525.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "set 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 558.5, 525.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.5, 525.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "set 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 409.0, 189.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.666672, 171.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 436.0, 363.0, 22.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.5, 264.5, 256.0, 58.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"patching_rect" : [ 426.0, 313.0, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 427.0, 270.5, 43.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.0, 64.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "r midi"
				}
...
,
					"patching_rect" : [ 389.0, 64.0, 66.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "channel_plug1.maxpat",
					"numinlets" : 4,
					"numoutlets" : 4,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 389.0, 124.0, 370.0, 116.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 203.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "s pressure"
				}
...
,
					"patching_rect" : [ 278.666687, 240.5, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 296.666687, 169.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 277.666687, 207.5, 24.0, 24.0 ],
					"style" : "",
					"varname" : "led[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 273.166687, 270.5, 33.0, 22.0 ],
					"style" : "",
					"text" : "s b2"
				}
...
,
					"patching_rect" : [ 222.166687, 240.5, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 226.666687, 207.5, 24.0, 24.0 ],
					"style" : "",
					"varname" : "led"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 471.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "Lid"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.5, 182.5, 58.0, 20.0 ],
					"style" : "",
					"text" : "Buttons"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.166687, 270.5, 33.0, 22.0 ],
					"style" : "",
					"text" : "s b1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.666672, 227.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "Pressure"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 35.666672, 203.0, 29.5, 100.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 188.5, 129.75, 62.0, 120.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.5, 445.0, 32.0, 22.0 ],
					"style" : "",
					"text" : "s lid"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 76.0, 445.0, 62.0, 123.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 259.5, 129.75, 62.0, 120.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 263.166687, 306.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.5, 191.75, 58.0, 58.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 210.166687, 306.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.5, 129.75, 58.0, 58.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"bgcolor" : [ 0.701961, 0.415686, 0.886275, 0.41 ],
					"id" : "obj-73",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1382.333374, 291.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 109.0, 121.541367, 228.25, 138.417267 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 1247.0, 75.0, 256.0, 182.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.999995, 6.75, 508.835175, 361.75 ],
					"tabname" : "filterBox"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 568.0, 561.0, 435.5, 561.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 45.166672, 195.0, 45.166672, 195.0 ],
					"order" : 1,
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 606.25, 561.0, 461.5, 561.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 606.25, 447.0, 538.0, 447.0 ],
					"order" : 1,
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 606.25, 447.0, 606.25, 447.0 ],
					"order" : 0,
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 650.5, 510.0, 538.0, 510.0 ],
					"order" : 1,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 538.0, 486.0, 538.0, 486.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 568.0, 447.0, 568.0, 447.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 568.0, 486.0, 568.0, 486.0 ],
					"order" : 1,
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 568.0, 510.0, 606.25, 510.0 ],
					"order" : 0,
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 606.25, 486.0, 606.25, 486.0 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 650.5, 447.0, 650.5, 447.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 236.166687, 234.0, 219.0, 234.0, 219.0, 264.0, 231.666687, 264.0 ],
					"order" : 0,
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 236.166687, 234.0, 207.0, 234.0, 207.0, 297.0, 219.666687, 297.0 ],
					"order" : 1,
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-72", 1 ],
					"midpoints" : [ 650.5, 561.0, 461.5, 561.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-72", 0 ],
					"midpoints" : [ 366.5, 561.0, 435.5, 561.0 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 242.166687, 204.0, 254.666687, 204.0 ],
					"source" : [ "obj-42", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-59", 0 ],
					"midpoints" : [ 238.166687, 195.0, 222.0, 195.0, 222.0, 234.0, 231.666687, 234.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 526.5, 321.0, 499.5, 321.0 ],
					"order" : 1,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-71", 0 ],
					"midpoints" : [ 526.5, 330.0, 690.25, 330.0 ],
					"order" : 0,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 499.5, 354.0, 445.5, 354.0 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 231.666687, 264.0, 207.0, 264.0, 207.0, 201.0, 236.166687, 201.0 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 288.166687, 264.0, 270.0, 264.0, 270.0, 204.0, 287.166687, 204.0 ],
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 306.666687, 195.0, 312.0, 195.0, 312.0, 234.0, 311.166687, 234.0 ],
					"source" : [ "obj-65", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 302.666687, 204.0, 303.0, 204.0, 303.0, 234.0, 288.166687, 234.0 ],
					"source" : [ "obj-65", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 287.166687, 234.0, 272.666687, 234.0 ],
					"order" : 1,
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 287.166687, 234.0, 270.0, 234.0, 270.0, 264.0, 282.666687, 264.0 ],
					"order" : 0,
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 690.25, 510.0, 568.0, 510.0 ],
					"order" : 1,
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 690.25, 510.0, 650.5, 510.0 ],
					"order" : 0,
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-72", 0 ],
					"midpoints" : [ 538.0, 561.0, 435.5, 561.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 96.5, 147.0, 45.166672, 147.0 ],
					"source" : [ "obj-97", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 122.900002, 156.0, 153.0, 156.0, 153.0, 300.0, 85.5, 300.0 ],
					"order" : 2,
					"source" : [ "obj-97", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 149.300003, 189.0, 219.0, 189.0, 219.0, 201.0, 236.166687, 201.0 ],
					"source" : [ "obj-97", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 0 ],
					"midpoints" : [ 122.900002, 156.0, 153.0, 156.0, 153.0, 300.0, 113.5, 300.0 ],
					"order" : 1,
					"source" : [ "obj-97", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 122.900002, 156.0, 164.0, 156.0 ],
					"order" : 0,
					"source" : [ "obj-97", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-66", 0 ],
					"midpoints" : [ 175.699997, 204.0, 287.166687, 204.0 ],
					"source" : [ "obj-97", 3 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-49" : [ "umenu[1]", "umenu[1]", 0 ],
			"obj-3" : [ "gain~", "gain~", 0 ],
			"obj-41" : [ "toggle", "toggle", 0 ],
			"obj-45" : [ "number", "number", 0 ],
			"obj-57" : [ "kslider", "kslider", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "channel_plug1.maxpat",
				"bootpath" : "~/Dropbox/All the things important/PHD/GitHubStuff/EngD-Work/maxEngD/littleAbstractions",
				"patcherrelativepath" : "../../../../littleAbstractions",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
