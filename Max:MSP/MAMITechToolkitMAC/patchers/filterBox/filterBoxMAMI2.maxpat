...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 203.0, 58.0, 58.0 ],
					"style" : "",
					"varname" : "led[1]"
				}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 13.0,
									"id" : "obj-28",
									"items" : [ "USB Receiver", ",", "USB Receiver 2", ",", "Comfort Curve Keyboard 2000", ",", "Comfort Curve Keyboard 2000 2", ",", "Apple Internal Keyboard / Trackpad", ",", "Apple Internal Keyboard / Trackpad 2", ",", "Apple Internal Keyboard / Trackpad 3" ],
									"labelclick" : 1,
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
...
,
		"dependency_cache" : [ 			{
				"name" : "bp.Oscillator.maxpat",
				"bootpath" : "~/Dropbox/All the things important/PHD/GitHubStuff/EngD-Work/maxEngD/TechToolkit/MAMITechToolkit/patchers",
				"patcherrelativepath" : "..",
				"type" : "JSON",
				"implicit" : 1
			}
