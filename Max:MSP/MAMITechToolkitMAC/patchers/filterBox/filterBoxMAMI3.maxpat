...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 619.0, 444.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 541.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 611.75, 413.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 694.25, 526.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 694.25, 496.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 135.5, 113.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 700.0, 591.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "set 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 715.0, 70.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "s scale"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 715.0, 37.0, 88.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 113.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 431.0, 371.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 431.0, 325.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "peak"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 371.0, 371.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 371.0, 325.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "trough"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 469.0, 561.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 29.0, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 644.25, 526.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 644.25, 496.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 113.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 611.75, 526.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 611.75, 496.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 73.5, 113.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "L"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 581.75, 526.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.75, 496.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 43.5, 113.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 405.0, 488.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.0, 591.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "set 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 604.25, 591.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 578.0, 561.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "set 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 515.0, 662.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 619.0, 369.0, 80.0, 13.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 619.0, 341.0, 80.0, 13.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 361.0, 421.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 352.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 515.0, 396.0, 22.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 59.0, 244.0, 52.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 84.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 58.0, 173.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 87.0, 115.0, 151.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 28.15509, 164.0, 22.0 ],
					"style" : "",
					"text" : "fromsymbol @separator D3_"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 0.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "r CTRLOut"
				}
...
,
					"patching_rect" : [ 182.0, 158.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 269.0, 137.0, 50.0, 22.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 498.0, 308.0, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 29.0, 249.0, 26.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.333344, 470.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "s pressure"
				}
...
,
					"patching_rect" : [ 79.0, 278.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 101.5, 207.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 101.5, 207.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 82.5, 245.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 201.0, 58.0, 58.0 ],
					"style" : "",
					"varname" : "led[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 79.0, 308.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "s b2"
				}
...
,
					"patching_rect" : [ 28.0, 278.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 31.5, 245.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 141.0, 58.0, 58.0 ],
					"style" : "",
					"varname" : "led"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 207.333328, 220.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "Lid"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.333336, 220.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "Buttons"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 308.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "s b1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.333344, 220.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "Pressure"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 128.333328, 251.0, 62.0, 123.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 135.5, 141.0, 62.0, 120.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 235.333328, 488.0, 32.0, 22.0 ],
					"style" : "",
					"text" : "s lid"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 205.333328, 251.0, 62.0, 123.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 227.0, 141.0, 62.0, 123.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 							{
								"box" : 								{
									...
									"fontsize" : 13.0,
									"id" : "obj-28",
									"items" : [ "Comfort Curve Keyboard 2000", ",", "Comfort Curve Keyboard 2000 2", ",", "USB Receiver", ",", "USB Receiver 2", ",", "Apple Internal Keyboard / Trackpad", ",", "Apple Internal Keyboard / Trackpad 2", ",", "Apple Internal Keyboard / Trackpad 3" ],
									"labelclick" : 1,
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
...
,
					"patching_rect" : [ 101.0, 158.0, 60.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 318.0, 256.0, 182.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 8.0, 367.12088, 261.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 37.5, 303.0, 25.0, 303.0, 25.0, 242.0, 41.0, 242.0 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-66", 0 ],
					"midpoints" : [ 88.5, 303.0, 76.0, 303.0, 76.0, 242.0, 92.0, 242.0 ],
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 96.5, 140.5, 317.5, 140.5 ],
					"source" : [ "obj-97", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 122.900002, 143.5, 370.5, 143.5 ],
					"order" : 2,
					"source" : [ "obj-97", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 149.300003, 151.5, 41.0, 151.5 ],
					"source" : [ "obj-97", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-66", 0 ],
					"midpoints" : [ 175.699997, 151.5, 92.0, 151.5 ],
					"source" : [ "obj-97", 3 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "bp.Oscillator.maxpat",
				"bootpath" : "~/Dropbox/All the things important/PHD/GitHubStuff/EngD-Work/maxEngD/AdrianNoodler/MAMI-master/MAMIproject/patchers",
				"patcherrelativepath" : "../../../../AdrianNoodler/MAMI-master/MAMIproject/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
