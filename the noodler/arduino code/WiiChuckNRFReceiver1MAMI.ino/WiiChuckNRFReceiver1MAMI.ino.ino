...
void showData() {
    if (newData == true) {
         ...
         Serial.print("4 ");Serial.println(dataReceived[3]);
         Serial.print("5 ");Serial.println(dataReceived[4]);
         Serial.print("6 ");Serial.println(dataReceived[5]);
         Serial.print("7 ");Serial.println(dataReceived[6]);
